          ...
          <div className="modal-dialog modal-lg">
            <div className="modal-content">
              ...
              <div className="modal-body">
                <div className='row'>
                <div className='col-6'>
                <h3><b>${currentServicio.price}</b></h3>
                <h1 className='fs-5 text-right'>{currentServicio.name}</h1>
                  <p className='fs-5 text-right'>{currentServicio.description}</p>
                  </div>
                  <div className='col-6'>

                  <img src={currentServicio.imageUrl} alt="" className='img-fluid rounded' />
                  </div>
